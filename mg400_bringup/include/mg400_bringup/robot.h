...
#include <mg400_bringup/commander.h> // You will have to convert this to ROS2 as well
...
#include <mg400_msgs/msg/pay_load.hpp>
#include <mg400_msgs/msg/do.hpp>
#include <mg400_msgs/srv/do_execute.hpp>
#include <mg400_msgs/msg/tool_do.hpp>
#include <mg400_msgs/srv/tool_do_execute.hpp>
#include <mg400_msgs/msg/ao.hpp>
#include <mg400_msgs/srv/ao_execute.hpp>
#include <mg400_msgs/msg/acc_j.hpp>
#include <mg400_msgs/msg/acc_l.hpp>
#include <mg400_msgs/msg/speed_j.hpp>
#include <mg400_msgs/msg/speed_l.hpp>
#include <mg400_msgs/msg/arch.hpp>
#include <mg400_msgs/msg/cp.hpp>
#include <mg400_msgs/msg/lim_z.hpp>
...
protected:
    ...
    bool enableRobot(const std::shared_ptr<rmw_request_id_t> request_header,
    ...
    bool disableRobot(const std::shared_ptr<rmw_request_id_t> request_header,
    ...
    bool continueScript(const std::shared_ptr<rmw_request_id_t> request_header,
    ...
    bool setSafeSkin(const std::shared_ptr<rmw_request_id_t> request_header,
    ...
    bool setObstacleAvoid(const std::shared_ptr<rmw_request_id_t> request_header,
    ...
    bool setCollisionLevel(const std::shared_ptr<rmw_request_id_t> request_header,
    ...
    bool moveJog(const std::shared_ptr<rmw_request_id_t> request_header,
...
private:
    void feedbackHandle(const rclcpp::TimerBase::SharedPtr& tm,
                        rclcpp_action::ServerGoalHandle<FollowJointTrajectory>::SharedPtr handle);
    void moveHandle(const rclcpp::TimerBase::SharedPtr& tm,
                    rclcpp_action::ServerGoalHandle<FollowJointTrajectory>::SharedPtr handle);
    void goalHandle(rclcpp_action::ServerGoalHandle<FollowJointTrajectory>::SharedPtr handle);
    void cancelHandle(rclcpp_action::ServerGoalHandle<FollowJointTrajectory>::SharedPtr handle);

...
public:
        ...
        : current_joint_{}, tool_vector_{}, real_time_data_{}, is_running_(false)
    {
        ...
        feed_back_tcp_ = std::make_shared<TcpClient>(ip, 30004);
    ...
    {
        char cmd[100];
        sprintf(cmd, "MovJ(%0.3f,%0.3f,%0.3f,%0.3f)", x, y, z, r);
    ...
    {
        char cmd[100];
        sprintf(cmd, "MovL(%0.3f,%0.3f,%0.3f,%0.3f)", x, y, z, r);
        real_time_tcp_->tcpSend(cmd, strlen(cmd));
    }
    ...
    {
        char cmd[100];
        sprintf(cmd, "JointMovJ(%0.3f,%0.3f,%0.3f,%0.3f)", j1, j2, j3, j4);
        real_time_tcp_->tcpSend(cmd, strlen(cmd));
    }
